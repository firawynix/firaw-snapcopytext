...
- [capture-modes-and-shortcuts](capture-modes-and-shortcuts.md) — Region overlay, named target pickers, native window render, and configurable hotkeys | flow | capture, windows, monitors, hotkeys
