...
- [capture-modes-and-shortcuts](capture-modes-and-shortcuts.md) — Target pickers, numbered actions, repeat selection, and hotkeys | flow | capture, clipboard, windows, monitors, hotkeys
